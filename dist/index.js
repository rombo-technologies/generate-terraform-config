...
var utils = __nccwpck_require__(9360);

var scopeOptionWarned = false;
/** @type {string} */
var _VERSION_STRING = (__nccwpck_require__(3976)/* .version */ .i8);
...
function getFileMeta(path) {
    return __awaiter(this, void 0, void 0, function* () {
        const meta = yield (0, promises_1.stat)(path);
        return {
            stats: meta,
            path,
        };
...
function ensureDirectoryForFileIsPresent(targetFile) {
    return __awaiter(this, void 0, void 0, function* () {
        const targetDir = (0, path_1.dirname)(targetFile);
        try {
            yield (0, promises_1.stat)(targetDir);
        }
        catch (_a) {
...
function writeTemplatedFile(targetFile, templateFile, context) {
    return __awaiter(this, void 0, void 0, function* () {
        targetFile = targetFile.replace('__tmpl__', '');
        const templateContents = yield (0, promises_1.readFile)(templateFile, {
            encoding: 'utf-8',
        });
        const contents = yield (0, ejs_1.render)(templateContents, context, {
            async: true,
        });
        yield (0, promises_1.writeFile)(targetFile, contents, { encoding: 'utf-8' });
    });
}
function generateFiles(templatesLocation, outputLocation, context) {
    return __awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __nccwpck_require__(3060);
const yaml_1 = __nccwpck_require__(6509);
...
var Node = __nccwpck_require__(925);
var Scalar = __nccwpck_require__(6266);
var resolveBlockMap = __nccwpck_require__(4030);
var resolveBlockSeq = __nccwpck_require__(6519);
var resolveFlowCollection = __nccwpck_require__(612);
...
var Document = __nccwpck_require__(6823);
var composeNode = __nccwpck_require__(4268);
var resolveEnd = __nccwpck_require__(5681);
var resolveProps = __nccwpck_require__(6712);
...
var Alias = __nccwpck_require__(7914);
var composeCollection = __nccwpck_require__(6040);
var composeScalar = __nccwpck_require__(7473);
var resolveEnd = __nccwpck_require__(5681);
var utilEmptyScalarPosition = __nccwpck_require__(1239);
...
var Node = __nccwpck_require__(925);
var Scalar = __nccwpck_require__(6266);
var resolveBlockScalar = __nccwpck_require__(8605);
var resolveFlowScalar = __nccwpck_require__(6143);
...
var directives = __nccwpck_require__(2996);
var Document = __nccwpck_require__(6823);
var errors = __nccwpck_require__(7420);
var Node = __nccwpck_require__(925);
var composeDoc = __nccwpck_require__(9207);
var resolveEnd = __nccwpck_require__(5681);
...
var Pair = __nccwpck_require__(425);
var YAMLMap = __nccwpck_require__(8217);
var resolveProps = __nccwpck_require__(6712);
var utilContainsNewline = __nccwpck_require__(8032);
var utilFlowIndentCheck = __nccwpck_require__(1656);
var utilMapIncludes = __nccwpck_require__(2759);
...
var YAMLSeq = __nccwpck_require__(8090);
var resolveProps = __nccwpck_require__(6712);
var utilFlowIndentCheck = __nccwpck_require__(1656);
...
var Alias = __nccwpck_require__(7914);
var Collection = __nccwpck_require__(3776);
var Node = __nccwpck_require__(925);
var Pair = __nccwpck_require__(425);
var toJS = __nccwpck_require__(1337);
var Schema = __nccwpck_require__(4348);
var stringify = __nccwpck_require__(8049);
var stringifyDocument = __nccwpck_require__(2454);
var anchors = __nccwpck_require__(4510);
var applyReviver = __nccwpck_require__(5324);
var createNode = __nccwpck_require__(5899);
var directives = __nccwpck_require__(2996);
...
var Node = __nccwpck_require__(925);
var visit = __nccwpck_require__(2530);
...
var composer = __nccwpck_require__(9177);
var Document = __nccwpck_require__(6823);
var Schema = __nccwpck_require__(4348);
var errors = __nccwpck_require__(7420);
var Alias = __nccwpck_require__(7914);
...
var YAMLMap = __nccwpck_require__(8217);
var YAMLSeq = __nccwpck_require__(8090);
var cst = __nccwpck_require__(5039);
var lexer = __nccwpck_require__(2307);
var lineCounter = __nccwpck_require__(5084);
var parser = __nccwpck_require__(4848);
var publicApi = __nccwpck_require__(8616);
var visit = __nccwpck_require__(2530);
...
var createNode = __nccwpck_require__(5899);
var stringifyPair = __nccwpck_require__(5376);
var addPairToJSMap = __nccwpck_require__(3830);
var Node = __nccwpck_require__(925);
...
var stringifyCollection = __nccwpck_require__(5641);
var addPairToJSMap = __nccwpck_require__(3830);
var Collection = __nccwpck_require__(3776);
var Node = __nccwpck_require__(925);
var Pair = __nccwpck_require__(425);
...
var log = __nccwpck_require__(4988);
var stringify = __nccwpck_require__(8049);
var Node = __nccwpck_require__(925);
var Scalar = __nccwpck_require__(6266);
var toJS = __nccwpck_require__(1337);
...
var resolveFlowScalar = __nccwpck_require__(6143);
var errors = __nccwpck_require__(7420);
var stringifyString = __nccwpck_require__(3926);
...
var cstScalar = __nccwpck_require__(1094);
var cstStringify = __nccwpck_require__(8658);
var cstVisit = __nccwpck_require__(9540);
...
var Node = __nccwpck_require__(925);
var map = __nccwpck_require__(5609);
var seq = __nccwpck_require__(5901);
var string = __nccwpck_require__(4258);
var tags = __nccwpck_require__(9370);
...
var Scalar = __nccwpck_require__(6266);
var stringifyNumber = __nccwpck_require__(4986);
...
var map = __nccwpck_require__(5609);
var _null = __nccwpck_require__(3755);
var seq = __nccwpck_require__(5901);
var string = __nccwpck_require__(4258);
var bool = __nccwpck_require__(587);
var float = __nccwpck_require__(8222);
var int = __nccwpck_require__(4359);
...
var float = __nccwpck_require__(8222);
var int = __nccwpck_require__(4359);
var schema = __nccwpck_require__(6250);
var schema$1 = __nccwpck_require__(5982);
var binary = __nccwpck_require__(2408);
var omap = __nccwpck_require__(8522);
var pairs = __nccwpck_require__(8283);
var schema$2 = __nccwpck_require__(7956);
var set = __nccwpck_require__(179);
var timestamp = __nccwpck_require__(3805);
...
var string = __nccwpck_require__(4258);
var binary = __nccwpck_require__(2408);
var bool = __nccwpck_require__(2354);
var float = __nccwpck_require__(8724);
var int = __nccwpck_require__(8122);
var omap = __nccwpck_require__(8522);
var pairs = __nccwpck_require__(8283);
var set = __nccwpck_require__(179);
var timestamp = __nccwpck_require__(3805);
...
var anchors = __nccwpck_require__(4510);
var Node = __nccwpck_require__(925);
var stringifyComment = __nccwpck_require__(2972);
var stringifyString = __nccwpck_require__(3926);
...
var Scalar = __nccwpck_require__(6266);
var foldFlowLines = __nccwpck_require__(5241);
